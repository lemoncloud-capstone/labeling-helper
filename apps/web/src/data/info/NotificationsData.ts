...
export const NotificationsDataMap: ExportFormatDataMap = {
    [Notification.EMPTY_LABEL_NAME_ERROR]: {
        ...
        description:
            "Looks like you didn't assign name to one of your labels. Unfortunately it is mandatory for " +
    ...
    [Notification.NON_UNIQUE_LABEL_NAMES_ERROR]: {
        ...
        description:
            'Looks like not all your label names are unique. Unique names are necessary to guarantee correct' +
    ...
    [Notification.MODEL_DOWNLOAD_ERROR]: {
        ...
        description:
            'Looks like we ware unable to download tensorflow.js model from external server. Make sure that ' +
            'you are connected to internet and try again.',
    },
    [Notification.MODEL_INFERENCE_ERROR]: {
        header: 'Inference failed',
        description:
            'Looks like we were unable to run inference of your image. Please help us improve Make Sense ' +
            'and let us know.',
    },
    [Notification.MODEL_LOAD_ERROR]: {
        header: 'Model could not be loaded',
        description:
            'Looks like we ware unable to load your tensorflow.js model from uploaded files. Make sure that ' +
    ...
    [Notification.LABELS_FILE_UPLOAD_ERROR]: {
        ...
        description:
            'Looks like you forgot to upload text file containing list of detected classes names. We need ' +
    ...
    [Notification.ANNOTATION_FILE_PARSE_ERROR]: {
        ...
        description:
            'The contents of an annotation file is not valid JSON, CSV, or XML. Please fix the files ' +
    ...
    [Notification.ANNOTATION_IMPORT_ASSERTION_ERROR]: {
        ...
        description:
            'Missing or invalid annotations provided during import. Please fix the files selected ' +
    ...
    [Notification.UNSUPPORTED_INFERENCE_SERVER_MESSAGE]: {
        ...
        description:
            'Integration with selected inference server is still under construction. Stay tuned for more ' +
