    ...
    private isImageChecked = (index: number): boolean => {
        ...
        switch (this.props.activeLabelType) {
            ...
            case LabelType.POINT:
                return (
                    imageData.labelPoints.filter((labelPoint: LabelPoint) => labelPoint.status === LabelStatus.ACCEPTED)
                        .length > 0
                );
            ...
            case LabelType.RECT:
                return (
                    imageData.labelRects.filter((labelRect: LabelRect) => labelRect.status === LabelStatus.ACCEPTED)
                        .length > 0
                );
        }
    };
