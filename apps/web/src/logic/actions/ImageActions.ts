...
export class ImageActions {
    ...
    public static setActiveLabelOnActiveImage(labelIndex: number): void {
        ...
        store.dispatch(updateImageDataById(imageData.id, ImageActions.mapNewImageData(imageData, labelIndex)));
    ...
    private static mapNewImageData(imageData: ImageData, labelIndex: number): ImageData {
        ...
        switch (labelType) {
            ...
            case LabelType.RECT:
                ...
                newImageData.labelRects = imageData.labelRects.map((labelRectangle: LabelRect) => {
