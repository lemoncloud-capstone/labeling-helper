...
export class PolygonRenderEngine extends BaseRenderEngine {
    ...
    private getPolygonUnderMouse(data: EditorData): LabelPolygon | null {
        ...
        const labelPolygons: LabelPolygon[] = LabelsSelector.getActiveImageData().labelPolygons.filter(
        ...
        for (const labelPolygon of labelPolygons) {
            const verticesOnCanvas = RenderEngineUtil.transferPolygonFromImageToViewPortContent(
                labelPolygon.vertices,
                data
            );
